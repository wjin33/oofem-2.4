...
public:
    ...
    virtual void updateNonlocalBarrier(FloatArray &points);
    ...
    virtual void giveAdvancingSection(FloatArray &oCenter, double &length);

    BasicGeometry *giveGeometry() { return mpBasicGeometry.get(); }

    bool IsLSIntersect(FloatArray &answer,const FloatArray &P1,const FloatArray &P2,const FloatArray &Q1,const FloatArray &Q2 );
