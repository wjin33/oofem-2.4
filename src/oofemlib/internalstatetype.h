...
#define InternalStateType_DEF \
    ...
    ENUM_ITEM_WITH_VALUE(IST_EquivalentStrainC, 115)\
    ENUM_ITEM_WITH_VALUE(IST_EquivalentStrainT, 116)\
    ENUM_ITEM_WITH_VALUE(IST_NonlocalEquivalentStrain, 117)\
    ENUM_ITEM_WITH_VALUE(IST_Permeability, 118)\
    ENUM_ITEM_WITH_VALUE(IST_DamageT1, 119)\
    ENUM_ITEM_WITH_VALUE(IST_DamageT2, 220)\
    ENUM_ITEM_WITH_VALUE(IST_DamageC1, 221)\
    ENUM_ITEM_WITH_VALUE(IST_DamageC2, 222)
