...
#define _IFT_NonlocalMaterialExtensionInterface_admnl2 "admnl2"
#define _IFT_NonlocalMaterialExtensionInterface_cl1 "cl1"
#define _IFT_NonlocalMaterialExtensionInterface_theta "theta"
 ...
 * and should be appropriate not to use aforementioned list and redefine the
...
protected:
    ...
    /// Angle between the axial and x-axis of transverse isotropic material
    double angle;
    /// The axial Characteristic internal length of of transverse isotropic material
    double cl1;
...
public:
    ...
    double giveInternalLength(){return cl;}
    /**
