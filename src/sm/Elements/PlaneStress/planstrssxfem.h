...
public:
    ...
    virtual void giveNumberofmSubTri(int &answer){ answer=mSubTri.size(); }
    virtual void giveXFEMExportData(std::vector< VTKPiece > &vtkPieces, std::vector<std::vector<FloatArray>> &IS, IntArray &primaryVarsToExport, IntArray &internalVarsToExport, IntArray cellVarsToExport, TimeStep *tStep);
