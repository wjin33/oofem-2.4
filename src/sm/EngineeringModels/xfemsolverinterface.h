...
public:
    ...
    void propagateXfemInterfaces(TimeStep *tStep, StaticStructural &ioEngngModel, bool iRecomputeStepAfterCrackProp);
    void mapVariables(TimeStep *tStep, StaticStructural &ioEngngModel);

    void propagateXfemInterfaces(TimeStep *tStep, staticstructuralarc &ioEngngModel, bool iRecomputeStepAfterCrackProp);
    void mapVariables(TimeStep *tStep, staticstructuralarc &ioEngngModel);
    ...
    void xfemUpdatePrimaryField(staticstructuralarc &ioEngngModel, TimeStep *tStep, const FloatArray &iNewSol);
