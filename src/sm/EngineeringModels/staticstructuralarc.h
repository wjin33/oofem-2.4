...
#ifndef staticstructuralarc_h
#define staticstructuralarc_h
...
///@name Input fields for staticstructuralarc
//@{
#define _IFT_staticstructuralarc_Name "staticstructuralarc"
#define _IFT_staticstructuralarc_controlmode "controlmode"
#define _IFT_staticstructuralarc_deltat "deltat"
#define _IFT_staticstructuralarc_stiffmode "stiffmode"
#define _IFT_staticstructuralarc_refloadmode "refloadmode"
#define _IFT_staticstructuralarc_keepll "keepll"
#define _IFT_staticstructuralarc_donotfixload "donotfixload"
#define _IFT_staticstructuralarc_nonlocstiff "nonlocstiff"
#define _IFT_staticstructuralarc_nonlocalext "nonlocalext"
#define _IFT_staticstructuralarc_loadBalancingFlag "loadbalancingflag"
#define _IFT_staticstructuralarc_forceloadBalancingFlag "forceloadbalancingflag"
#define _IFT_staticstructuralarc_updateElasticStiffnessFlag "updateelasticstiffnessflag"
#define _IFT_staticstructuralarc_recomputeaftercrackpropagation "recomputeaftercrackprop"
//@}

namespace oofem {
/// Type determining the stiffness mode.
enum staticstructuralarc_stiffnessMode {
...
enum staticstructuralarc_controlType {
 ...
 * - Managing time steps.
 */
class staticstructuralarc : public LinearStatic, public XfemSolverInterface
{
protected:
    ...
    staticstructuralarc_stiffnessMode stiffMode;
    int loadInitFlag;
    ...
    staticstructuralarc_controlType controlMode;
...
public:
    staticstructuralarc(int i, EngngModel * _master = NULL);
    virtual ~staticstructuralarc();
    ...
    // identification
    virtual const char *giveClassName() const { return "staticstructuralarc"; }
